...
class Simulator:
    ...
    def __init__(self, host, port, timeout, rendering = False,
        ...
        settings.synchronous_mode = synchronous_execution
        settings.fixed_delta_seconds = temporal_resolution
        settings.substepping = True
        settings.max_substeps = 10
        settings.max_substep_delta_time = temporal_resolution / settings.max_substeps
        ...
        traffic_manager.set_synchronous_mode(synchronous_execution)
